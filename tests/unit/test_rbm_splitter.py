...
df_rating, X = python_dataset(test_specs)
...
Xtr, Xtst, train_df, test_df, maps = split.stratified_split(ratio= test_specs()['ratio'], seed= test_specs()['seed'])
