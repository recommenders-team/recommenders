...
@pytest.fixture
def _index_and_fit_sql(spark, df_all, header):
    ...
    query = "select " + header["col_user"] + ", " + \
            ...
            header["col_rating"] + ", " + header["col_timestamp"] + " from df_all"
    ...
    return df_all, unique_users, unique_items, user_map_dict, item_map_dict, index2user, index2item
