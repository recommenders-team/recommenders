...
| [rbm](rbm_movielens.ipynb)| MovieLens | Python CPU, GPU | Use the Restricted Boltzmann Machine (rbm) [4] to predict movie ratings in a Python+GPU (TensorFlow) environment.<br>
