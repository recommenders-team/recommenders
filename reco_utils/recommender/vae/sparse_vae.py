...
def binarize_matrix(data, threshold):
    """Takes a matrix as an input, and binarizes its entries based on a certain threshold.
    
    Args: 
        data (np.array, float): the matrix of user-item interaction with ratings.
        threshold (float): the threshold for binarization.
        
    Returns:
        data_ (np.array, int): the click matrix.
    """
    data_ = data.copy()
    data_[data_ < threshold] = 0
    data_[data_ > threshold] = 1
...
class AffinityMatrix:
    ...
    def __init__(
        self,
        DF,
        items_list, # LSECHANGE: added for controlling the number of items 
        ...
        self.items_list = items_list # LSECHANGE: list of unique items to use
    ...
    def _gen_index(self):
        ...
        unique_items = self.items_list # LSECHANGE: use this list instead of unique items of DF
