...
We provide a script to [generate a conda file](scripts/generate_conda_file.py), depending of the environment we want to use. This will create the environment using the Python version 3.6 with all the correct dependencies.
