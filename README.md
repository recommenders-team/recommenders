...
| Neural News Recommendation with Long- and Short-term User Representations (LSTUR) | [Python CPU / Python GPU](notebooks/00_quick_start/lstur_synthetic.ipynb) | Content-Based Filtering | Deep learning algorithm considering users' long- and short-term preference to provide powerful news or article recommendations |
| Neural News Recommendation with Attentive Multi-View Learning (NAML) | [Python CPU / Python GPU](notebooks/00_quick_start/naml_synthetic.ipynb) | Content-Based Filtering | Deep learning algorithm with multi-view learning to provide powerful news or article recommendations |
...
| Neural News Recommendation with Personalized Attention (NPA) | [Python CPU / Python GPU](notebooks/00_quick_start/npa_synthetic.ipynb) | Content-Based Filtering | Deep learning algorithm ultilizing personalized attention for powerful news or article recommendations |
| Neural News Recommendation with Multi-Head Self-Attention (NRMS) | [Python CPU / Python GPU](notebooks/00_quick_start/nrms_synthetic.ipynbb) | Content-Based Filtering | Deep learning algorithm ultilizing multi-head self-attention for powerful news or article recommendations |
